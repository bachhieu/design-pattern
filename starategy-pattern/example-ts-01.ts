...
const ConcreteStrategy1 = new StrategyPattern.Context(new StrategyPattern.ConcreteStrategy1()).executeStrategy()
const ConcreteStrategy2 = new StrategyPattern.Context(new StrategyPattern.ConcreteStrategy2()).executeStrategy()
const ConcreteStrategy3 = new StrategyPattern.Context(new StrategyPattern.ConcreteStrategy3()).executeStrategy()
